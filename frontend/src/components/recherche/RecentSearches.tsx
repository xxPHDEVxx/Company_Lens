...
const RecentSearches = () => {
    ...
    return (
      <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
        <div className="p-4 sm:p-6 border-b border-gray-200">
          <h2 className="text-base sm:text-lg font-semibold text-gray-800">Recherches récentes</h2>
          <p className="text-xs sm:text-sm text-gray-600 mt-1">Vos dernières analyses d'entreprises</p>
        </div>
        <div className="p-4 sm:p-6">
          <div className="animate-pulse space-y-3 sm:space-y-4">
            {[1, 2, 3].map((i) => (
              <div key={i} className="flex items-center p-3 sm:p-4 bg-gray-50 rounded-xl">
                <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gray-200 rounded-lg mr-3 sm:mr-4 flex-shrink-0"></div>
  ...
  return (
    <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
      <div className="p-4 sm:p-6 border-b border-gray-200">
        <h2 className="text-base sm:text-lg font-semibold text-gray-800">Recherches récentes</h2>
        <p className="text-xs sm:text-sm text-gray-600 mt-1">Vos 5 dernières analyses d'entreprises</p>
      </div>
      <div className="p-4 sm:p-6">
        <div className="space-y-3 sm:space-y-4">
          {displayedSearches.map((search, index) => (
            <div
              ...
              className="flex items-center justify-between p-3 sm:p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors cursor-pointer"
            >
              <div className="flex items-center min-w-0 flex-1">
                ...
                <div className="min-w-0 flex-1">
                  <h3 className="font-semibold text-sm sm:text-base text-gray-900 truncate">{search.name}</h3>
                  <p className="text-xs sm:text-sm text-gray-600 break-all">{search.vat}</p>
                </div>
              </div>
              <div className="text-xs sm:text-sm text-gray-500 ml-2 flex-shrink-0 hidden sm:block">
