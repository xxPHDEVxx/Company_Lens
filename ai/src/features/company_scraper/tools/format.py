...
from src.features.company_scraper.config.aggregators import AGGREGATORS_DOMAINS
from src.features.company_scraper.tools.utils import safe_execution
import re
transformer = MarkdownifyTransformer()


# Needs review and improvement for better performance
def kbo_entity_format(soup: BeautifulSoup) -> str:
    """
