class URL:
    ...
    AZURE_MAP_API = "https://atlas.microsoft.com/search/address/batch/sync/json"
    ...
    NBB_XBRL_DEPOSIT = "http://consult.cbso.nbb.be/api/external/broker/public/deposits/xbrl/{deposit_id}"
