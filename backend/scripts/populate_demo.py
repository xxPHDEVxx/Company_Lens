...
from companies.models import Company, Establishment, FinancialData, CompanyFollower
...
def create_demo_data():
    ...
    companies_data = [
        {
            ...
            'company_description': 'Leading technology solutions provider specializing in AI and cloud computing',
        },
        {
            'id': 'comp-002',
            'vat': 'BE0987654321',
            ...
            'company_description': 'Renewable energy solutions for Belgian businesses',
        },
        {
            'id': 'comp-003',
            'vat': 'BE0456789123',
            ...
            'company_description': 'International logistics and supply chain management',
        },
        {
            'id': 'comp-004',
            'vat': 'BE0789123456',
            ...
            'company_description': 'Biotechnology research and pharmaceutical development',
        },
        {
            'id': 'comp-005',
            'vat': 'BE0321654987',
            ...
            'company_description': 'Industrial manufacturing and automation solutions',
        },
        {
            'id': 'comp-006',
            'vat': 'BE0147258369',
            ...
            'company_description': 'Digital marketing and social media management',
        },
        {
            'id': 'comp-007',
            'vat': 'BE0963852741',
            ...
            'company_description': 'Export of Belgian food products worldwide',
        },
        {
            'id': 'comp-008',
            'vat': 'BE0852741963',
            ...
            'company_description': 'Diamond trading and jewelry manufacturing',
        },
        {
            'id': 'comp-009',
            'vat': 'BE0741852963',
            ...
            'company_description': 'Non-profit healthcare technology for hospitals',
        },
        {
            'id': 'comp-010',
            'vat': 'BE0159357852',
            ...
            'company_description': 'Sustainable construction and renovation services',
        }
    ]
    ...
    for company_data in companies_data:
        ...
        if created:
            ...
            # Add financial data for last 3 years
