"""
Django settings for Company Lens project.
...
ROOT_URLCONF = 'company_lens.urls'
...
WSGI_APPLICATION = 'company_lens.wsgi.application'
...
LANGUAGE_CODE = 'en-us'
TIME_ZONE = 'Europe/Brussels'  # Belgian timezone
USE_I18N = True
USE_TZ = True
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@companylens.be')
